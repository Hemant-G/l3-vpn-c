# # ==============================================================================
# # VPN Network Environment & Build Makefile
# # ==============================================================================
...
# .PHONY: all setup setup-net setup-tun build run-server run-client clean teardown
...
# $(CLIENT_BIN): $(SRC_DIR)/vpn_client.c $(SRC_DIR)/tun.c $(SRC_DIR)/socket.c | $(BUILD_DIR)
# 	$(CC) $(CFLAGS) $^ -o $@

# $(SERVER_BIN): $(SRC_DIR)/vpn_server.c $(SRC_DIR)/tun.c $(SRC_DIR)/socket.c | $(BUILD_DIR)
# 	$(CC) $(CFLAGS) $^ -o $@
...
# 	@echo "[+] Configuring server forwarding, gateway, and host NAT..."
...
# 	sudo ip netns exec $(CLIENT_NS) ip route add default via $(VPN_SERVER_GW)
